...
## PKS
fly -t ci set-pipeline -p deploy-pks -c pipelines/standard-product-pipeline.yml -l environments/vsphere/lab/common-pipeline-params.yml -v product=pivotal-container-service -n
